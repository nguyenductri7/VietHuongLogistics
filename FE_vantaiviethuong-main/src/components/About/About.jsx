import { useRef, useEffect, Suspense, useState, useCallback, useMemo, lazy } from 'react'
...
const AboutTruckScene = lazy(() => import('./AboutTruckScene'))
      ...
      <div className={styles.stickyWrap}>
        ...
        <div ref={canvasWrapRef} className={styles.canvasCol}>
          ...
          <Suspense fallback={null}>
            <AboutTruckScene targetRef={truckTarget} invalidateRef={invalidateRef} />
          </Suspense>
        </div>
      </div>
    </section>
